        ...
        return (
          <TooltipProvider key={index}>
            <Tooltip delayDuration={300}>
              <TooltipTrigger asChild>
                ...
                >
                  {isEditing ? (
                    ...
                    <div
                      className="relative px-3 py-1 rounded-md backdrop-blur-sm"
                      style={{
                        fontFamily: caption.fontFamily || "Inter",
                        fontSize: `${caption.fontSize || 32}px`,
                        color: caption.color || "#ffffff",
                    ...
                    >
                      ...
                      {isSelected && (
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 flex gap-1 bg-primary px-2 py-1 rounded-md shadow-lg">
              ...
              <TooltipContent side="top" className="bg-black/90 text-white border-primary">
                <p className="text-xs">Drag to reposition • Double-click to edit</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        );
